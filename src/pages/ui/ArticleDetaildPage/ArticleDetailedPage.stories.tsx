...
LightArticleDetaildPage.decorators = [StoreDecorator({ articleDetails: article })];

export const DarkArticleDetaildPage = Template.bind({});
DarkArticleDetaildPage.args = {};
DarkArticleDetaildPage.decorators = [ThemeDecorator(Theme.DARK), StoreDecorator({ articleDetails: article })];
