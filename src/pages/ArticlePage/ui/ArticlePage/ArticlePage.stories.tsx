...
LightArticleDetails.decorators = [RouterDecorator, StoreDecorator({}), ThemeDecorator(Theme.LIGHT)];

export const DarkArticleDetails = Template.bind({});
DarkArticleDetails.args = {};
DarkArticleDetails.decorators = [RouterDecorator, StoreDecorator({}), ThemeDecorator(Theme.DARK)];
