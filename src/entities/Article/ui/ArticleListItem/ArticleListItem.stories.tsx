...
LightArticleListItem.args = { view: ArticleView.SMALL, article };
LightArticleListItem.decorators = [];

export const DarkArticleListItem = Template.bind({});
DarkArticleListItem.args = { view: ArticleView.SMALL, article };
...
export const OrangeArticleListItem = Template.bind({});
OrangeArticleListItem.args = { view: ArticleView.SMALL, article };
OrangeArticleListItem.decorators = [ThemeDecorator(Theme.ORANGE)];

export const OrangeArticleListItemBIG = Template.bind({});
OrangeArticleListItemBIG.args = { view: ArticleView.BIG, article };
