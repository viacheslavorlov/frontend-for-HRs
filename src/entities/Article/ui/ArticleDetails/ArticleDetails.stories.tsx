...
import { ArticleBlockType, ArticleType } from '../../model/types/type';
...
DarkArticleDetailsError.decorators = [ThemeDecorator(Theme.DARK), StoreDecorator({
    articleDetails: {
        error: 'error',
    },
})];

export const DarkArticleLoading = Template.bind({});
DarkArticleLoading.args = {};
DarkArticleLoading.decorators = [ThemeDecorator(Theme.DARK), StoreDecorator({
    articleDetails: {
        isLoading: true,
    },
})];
